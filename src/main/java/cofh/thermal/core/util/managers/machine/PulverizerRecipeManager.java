...
public class PulverizerRecipeManager extends SingleItemRecipeManager.Catalyzed {
    ...
    public void refresh(RecipeManager recipeManager) {
        ...
        clear();
        for (var recipe : recipeManager.getAllRecipesFor(PULVERIZER_RECIPE.get())) {
            addRecipe(recipe.value());
        }
        for (var recipe : recipeManager.getAllRecipesFor(PULVERIZER_RECYCLE_RECIPE.get())) {
            addRecipe(recipe.value(), BaseMachineRecipe.RecipeType.DISENCHANT);
        }
        for (var recipe : recipeManager.getAllRecipesFor(PULVERIZER_CATALYST.get())) {
